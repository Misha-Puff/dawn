...
export class Slideshow extends Component {
  ...
  get isNested() {
    // hz rename: Dawn's global.js:1060 already defines `slideshow-component`; this element ships as `hz-slideshow-component`
    return this.parentElement?.closest('hz-slideshow-component') !== null;
  }
  ...
  #handleMouseDown = (event) => {
    ...
    const onPointerMove = (event) => {
      ...
      if (!moved) {
        ...
        // hz rename: Dawn's global.js:1060 already defines `slideshow-component`; this element ships as `hz-slideshow-component`
        const closestSlideshow = this.parentElement?.closest('hz-slideshow-component');
...
// hz rename: Dawn's global.js:1060 already defines `slideshow-component`; this element ships as `hz-slideshow-component`
if (!customElements.get('hz-slideshow-component')) {
  customElements.define('hz-slideshow-component', Slideshow);
}
